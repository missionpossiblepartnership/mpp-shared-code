...
COUNTRY_REFERENCE = {'ABW': {'continent': 'North America',
         'country_name': 'Aruba',
         'region': 'Caribbean'},
 'AFG': {'continent': 'Asia',

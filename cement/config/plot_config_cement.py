...
TECHNOLOGY_LAYOUT = {
    ...
    "Dry kiln alternative fuels 90%": "#0000b3",
    "Dry kiln alternative fuels + post combustion + storage": "#0000ff",
    "Dry kiln alternative fuels + post combustion + usage": "#1a1aff",
    "Dry kiln alternative fuels + oxyfuel + storage": "#4d4dff",
    "Dry kiln alternative fuels + oxyfuel + usage": "#6666ff",
    "Dry kiln alternative fuels + direct separation + storage": "#9999ff",
    "Dry kiln alternative fuels + direct separation + usage": "#b3b3ff",
}
